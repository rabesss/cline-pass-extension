import { buildProviderConfig, CLINE_PASS_MODELS, commandUsage, formatCommandResult, runClinePassCommand, } from "./core.js";
    ...
    pi.registerCommand("clinepass", {
        ...
        handler: async (args, ctx) => {
            ...
            try {
                ...
                emit(ctx, wantsJson ? JSON.stringify({ ok: false, command: "clinepass", message }, null, 2) : `FAIL clinepass: ${message}\n\n${commandUsage()}`, "error");
            }
        },
    });
}
