...
export const RECOMMENDED_MODELS_PATH = "/ai/cline/recommended-models";
export const RECOMMENDED_MODELS_URL = `${CLINE_API_BASE}${RECOMMENDED_MODELS_PATH}`;
export const UNKNOWN_LIVE_MODEL_CONTEXT_WINDOW = 128_000;
export const UNKNOWN_LIVE_MODEL_MAX_TOKENS = 8_192;
